...
public class MainWindowFrameController
{
    ...
    private void handleShowAll(ActionEvent event) throws IOException
    {
        ...
        Pane root = loader.load(getClass().getResource("/gui/common/ShowAllSubscribers.fxml").openStream());
    ...
    private void handleSearch(ActionEvent event) throws IOException
    {
        ...
        else
        {
            ...
            {
                ((Node) event.getSource()).getScene().getWindow().hide(); //hiding primary window
                Pane root = loader.load(getClass().getResource("/gui/common/EditSubscriber.fxml").openStream());
    ...
    {
        Parent root = FXMLLoader.load(getClass().getResource("/gui/common/MainWindow.fxml"));
