...
public class ClientPortFrameController
{
    ...
    {
        Parent root = FXMLLoader.load(getClass().getResource("/gui/common/ClientPort.fxml"));

        Scene scene = new Scene(root);
        scene.getStylesheets().add(getClass().getResource("/gui/common/ClientPort.css").toExternalForm());
